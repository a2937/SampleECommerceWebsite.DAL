...
namespace SampleECommerceWebsite.DAL.Migrations
{
    public partial class TSQL : Migration
    {
        ...
        {
            string sql = "CREATE FUNCTION Store.GetOrderTotal ( @OrderId UNIQUEIDENTIFIER ) " +
            ...
            sql = "CREATE PROCEDURE [Store].[PurchaseItemsInCart](@customerId UNIQUEIDENTIFIER = '0', @orderId UNIQUEIDENTIFIER OUTPUT) AS BEGIN " +
              " SET NOCOUNT ON; " +
