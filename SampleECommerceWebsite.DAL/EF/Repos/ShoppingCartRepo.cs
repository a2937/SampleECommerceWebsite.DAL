...
namespace SampleECommerceWebsite.DAL.EF.Repos
{
    public class ShoppingCartRepo : RepoBase<ShoppingCartRecord>, IShoppingCartRepo
    {
        ...
        {
            return Update(entity, _productRepo.Find(entity.ProductId)?.Result.UnitsInStock, persist);
        }
        ...
        {
            return Add(entity, _productRepo.Find(entity.ProductId)?.Result.UnitsInStock, persist);
        }
