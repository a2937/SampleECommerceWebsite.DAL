...
namespace SampleECommerceWebsite.DAL.EF
{
    public class StoreContext : IdentityDbContext<Customer,IdentityRole<int>,int>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            @"Server=(localdb)\mssqllocaldb;Database=SampleECommerceWebsite;Trusted_Connection=True;MultipleActiveResultSets=true;");
            }
            //if (!optionsBuilder.IsConfigured)
            //{
            //    optionsBuilder.UseSqlServer(
